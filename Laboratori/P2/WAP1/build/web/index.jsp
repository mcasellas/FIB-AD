      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#about">Registrar Imatge</a></li>
            <li><a href="#contact">Llista les imatges</a></li>
            <li><a href="#contact">Busca una imatge</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="page-header">
       ...
       <%
        ...
        <div class="col-sm-6">
          <img src="./Image/<%= rs.getString("filename") %>" data-src="holder.js/200x200" class="img-thumbnail" alt="A generic square placeholder image with a white border around it, making it resemble a photograph taken with an old instant camera">
        ...
        <div class="col-sm-6">
            ...
            <li class="list-group-item">Usuari: <%= rs.getString("username") %></li>
            <li class="list-group-item">Tags: <%= rs.getString("tags") %></li>
          </ul>
        <%
                       if (rs.getString("username").equals("sergi")){ 
                       %>
