 ...
 * 
 */
@WebServiceClient(name = "FotOkWS", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:8080/P3_SOAP/FotOkWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/P3_SOAP/FotOkWS?wsdl");
